export const makeConfirmEmailContent = (user: any, confirmationUrl: string) => {
    return `
    <!DOCTYPE html>
    <html lang="pt-br">
                        ...
                        <tr>
                            <td>
                                <table style="padding: 0.2em; text-align: center; width: 100%;">
                                    ...
                                    <tr>
                                        <td style="background-color: gray; height: 0.4px; width: 100%; margin: 10px 0;"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td style="background-color: #2C1CEE; color: white; border: 0; padding: 10px; width: 50%; border-radius: 5px; font-size: 1.1em; cursor: pointer; margin: 10px; display: inline-block;">
...
export const makeRedirectForURL = (redirectUrl: string) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
