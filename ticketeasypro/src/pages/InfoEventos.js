              ...
              <div className={stylese.filtro_localidade_estado_col}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      FiltroLocalidade("AC", 0, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("AL", 1, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("AP", 2, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("AM", 3, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("BA", 4, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("CE", 5, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("DF", 6, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("ES", 7, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("GO", 8, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("MA", 9, e.target.checked)
                    }
                  />
                </div>
              </div>
              <div className={stylese.filtro_localidade_estado_col}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("MT", 10, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("MS", 11, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("MG", 12, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("PA", 13, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("PB", 14, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("PR", 15, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("PE", 16, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("PI", 17, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("RJ", 18, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("RN", 19, e.target.checked)
                    }
                  />
                </div>
              </div>
              <div className={stylese.filtro_localidade_estado_col}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("RS", 20, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("RO", 21, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("RR", 22, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("SC", 23, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("SP", 24, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("SE", 25, e.target.checked)
                    }
                  />
                </div>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-check-input"
                    onChange={(e) =>
                      FiltroLocalidade("TO", 26, e.target.checked)
                    }
                  />
                </div>
              </div>
          ...
          {dados.length == 0 ? (
            ...
            <div>
              <div>
                <label>
                  Página{" "}
                  {dados.length / 6 <= 1 ? 1 : Math.ceil(dados.length / 6)} -{" "}
                  {dados.length <= 6 ? dados.length : 6} de {dados.length}{" "}
                  eventos.
                </label>
