...
export default function ListaEventos() {
  ...
  const ValidarIngresso = () => {
    if (tipoEvento == "" || evento == "") {
      handleSetMessage("Selecione o tipo de evento e o evento.", "error");
      return;
    }
  ...
  return (
    <div>
      ...
      <CabecalhoInfoColaborador secao="Validar ingressos" />
        ...
        <div className={styles.formulario_colaborador}>
          <div className={styles.cabecalho}>
            ...
            <label className={styles.subtitulo}>
              Preencha os dados abaixo para validar o ingresso do cliente.
            </label>
          </div>
          <hr />
          <div className={styles.formulario_campos_colaborador}>
            <form>
              <div className="form-group">
                <label htmlFor="TxtTipoEvento">Tipo do evento</label>
                <select
                  id="TxtTipoEvento"
                ...
                >
                  ...
                  <option value="Futebol">Palmeiras vs Inter de Limeira</option>
                  <option value="Festas">Festas</option>
                  <option value="Eventos culturais">Eventos culturais</option>
                  <option value="Festivais">Festivais</option>
                </select>
                <br />
                <label htmlFor="TxtNomeEvento">Nome do evento</label>
                <select
                  id="TxtNomeEvento"
                  className="form-select"
                ...
                >
                  ...
                  <option value="Futebol">Palmeiras vs Inter de Limeira</option>
                  <option value="Festas">Formatura da FATEC SP</option>
                  <option value="Eventos culturais">Capoeira</option>
                  <option value="Festivais">Festival do Japão 2024</option>
                </select>
                <br />
                <button
                  type="button"
